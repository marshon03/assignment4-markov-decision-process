...
from frozen_lake.q_learning import frozenlake_q_learning
from policy_iteration import policy_iteration
from taxi.q_learning import taxi_q_learning
...
@timing
def value_iteration_local(problem, R=None, T=None, gamma=0.9, max_iterations=10 ** 6, delta=10 ** -3):
...
@timing
def policy_iteration_local(problem, R=None, T=None, gamma=0.9, max_iterations=10 ** 6, delta=10 ** -3):
...
def run_discrete(environment_name, mapping=None, shape=None):
    ...
    if environment_name == 'TaxiEnv-v1':
        ...
        visualize_value(Vi, environment_name, problem.desc.shape, 'Value estimates - Modified transition model')
...
shape = (8, 8)
run_discrete(environments.get_small_frozen_lake_environment(), mapping, shape)

# FROZEN LAKE LARGE
shape = (20, 20)
run_discrete(environments.get_large_frozen_lake_environment(), mapping, shape)

# TAXI
shape = (25, 20)
mapping = {0: "S", 1: "N", 2: "E", 3: "W", 4: "P", 5: "D"}
run_discrete(environments.get_taxi_environment(), mapping, shape)
